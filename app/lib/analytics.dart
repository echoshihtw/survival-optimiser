...
class Analytics {
  ...
  // ── App lifecycle ─────────────────────────────
  static Future<void> appOpened() => _fa.logAppOpen();

  // ── Screen views ──────────────────────────────
  static Future<void> screenHUD() => _fa.logScreenView(screenName: 'hud');
  static Future<void> screenLog() =>
      _fa.logScreenView(screenName: 'transaction_log');
  static Future<void> screenSim() => _fa.logScreenView(screenName: 'simulator');
  static Future<void> screenConfig() => _fa.logScreenView(screenName: 'config');
  static Future<void> screenShare() => _fa.logScreenView(screenName: 'share');

  // ── Transaction events ────────────────────────
  // ✅ tracks type only — never amount
  static Future<void> addTransaction(String type) => _fa.logEvent(
  ...
  static Future<void> addLoan(String source) => _fa.logEvent(
    name: 'add_loan',
    parameters: {
  ...
  static Future<void> repayLoan() => _fa.logEvent(name: 'repay_loan');

  // ── Subscription events ───────────────────────
  // ✅ tracks cycle only — never amount
  static Future<void> addSubscription(String cycle) => _fa.logEvent(
  ...
  static Future<void> setBudget() => _fa.logEvent(name: 'set_budget');

  static Future<void> clearBudget() => _fa.logEvent(name: 'clear_budget');
  ...
  // ── Share events ──────────────────────────────
  // Tracks share surface only; no financial amounts or user labels.
  static Future<void> shareImage(String surface) =>
      _fa.logEvent(name: 'share_image', parameters: {'surface': surface});

  static Future<void> shareText(String surface) =>
      _fa.logEvent(name: 'share_text', parameters: {'surface': surface});
  ...
  static Future<void> toggleGlassEffect(bool enabled) => _fa.logEvent(
    name: 'toggle_glass_effect',
  ...
  static Future<void> onboardingSkipped(int step) =>
      _fa.logEvent(name: 'onboarding_skipped', parameters: {'at_step': step});

  // ── Paywall events ────────────────────────────
  static Future<void> paywallShown(String trigger) => _fa.logEvent(
    name: 'paywall_shown',
    parameters: {
